...
router.post('/chat', async (req, res) => {
  ...
  const predefinedResponses = {
    ...
    'where can i find career resources': 'You can find career resources at "/career_resources". It includes guides, tools, and tips for career development.',
    ...
    'how can i access career trends': 'Visit "/Career_Trends" to explore the latest career trends and insights.',
